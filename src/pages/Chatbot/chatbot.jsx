...
socket.on('node-message', (message) => {
  ...
  const handleContactSelection = async (contact) => {
    ...
    // Remove the new message indicator when the contact is selected
    setContacts(prevContacts => 
      prevContacts.map(c => 
...
//       }else{console.log("bro you got fucked");}
//     }
//   };
...
//         }
//         await axiosInstance.post(
//           'https://8twdg37p-8080.inc1.devtunnels.ms/send-message',
//           {
//             phoneNumbers: [phoneNumber],
//             message: newMessage.content,
//           }
...
//       if (formattedConversation.length === 0) {console.log("idhar aaya");return;}
...
//     const handleRedirect = () => {
//       window.location.href = 'https://www.facebook.com/v18.0/dialog/oauth?client_id=1546607802575879&redirect_uri=https%3A%2F%2Fcrm.nuren.ai%2Fll%2Fchatbot&response_type=code&config_id=422565194169944&state=pass-through%20value';
//     };
