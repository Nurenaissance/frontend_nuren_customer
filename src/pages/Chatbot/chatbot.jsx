            ...
            <div className="chat-header">
              ...
              <div className="chat-header-right">
                <div className='box-chatbot1'>
                  <MailIcon className="header-icon" style={{ width: '20px', height: '20px' }} onClick={handleMailIconClick} />
                </div>
                <div className='box-chatbot1'>
                  <CallRoundedIcon className="header-icon" style={{ width: '20px', height: '20px' }} onClick={handleDirectCallClick}/>
                </div>
              </div>
            </div>
          </div>
